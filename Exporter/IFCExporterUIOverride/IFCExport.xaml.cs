...
namespace BIM.IFC.Export.UI
{
   ...
   public partial class IFCExport : ChildWindow
   {
      ...
      private void buttonEditSetup_Click(object sender, RoutedEventArgs args)
      {
         ...
         editorWindow.LoadConfiguaration(logPath);
         
        //bool? ret = editorWindow.ShowDialog();
        //if (ret.HasValue)
        //   m_EditConfigVisited = ret.Value;
        m_EditConfigVisited = true;
      ...
      public void SelectFileDirectoryAndSelectConfiguration(string logPath)
      {
         this.logPath = logPath;
        // buttonBrowse_Click(null, null);
         buttonEditSetup_Click(null, null);
